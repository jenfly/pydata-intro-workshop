...
Please make sure to download and install the required libraries on your laptop prior to the workshop ([setup instructions are here](https://jenfly.github.io/pydata-intro-workshop/SETUP)).
